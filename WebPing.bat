...
ping localhost>nul
echo -------------------------------------------------------------------------------------
echo If you do not close this in 45 seconds you will go to https://sites.google.com/view/hstyle-addstyletoyourlife/home
echo -------------------------------------------------------------------------------------
ping localhost>nul
echo This is the IP=
ping %input%
...
start iexplore.exe https://sites.google.com/view/hstyle-addstyletoyourlife/home
exit
:exit
exit
